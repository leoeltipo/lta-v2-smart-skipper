...
# Hierarchical cell: ublaze_seq_mem
proc create_hier_cell_ublaze_seq_mem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_ublaze_seq_mem() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net SYS_Rst_1 [get_bd_pins SYS_Rst] [get_bd_pins dlmb_bram_if_cntlr/LMB_Rst] [get_bd_pins dlmb_v10/SYS_Rst] [get_bd_pins ilmb_bram_if_cntlr/LMB_Rst] [get_bd_pins ilmb_v10/SYS_Rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins USER_CLK] [get_bd_pins dlmb_bram_if_cntlr/LMB_Clk] [get_bd_pins dlmb_v10/LMB_Clk] [get_bd_pins ilmb_bram_if_cntlr/LMB_Clk] [get_bd_pins ilmb_v10/LMB_Clk]
...
proc create_hier_cell_ublaze_hie { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_debug_1 [get_bd_intf_pins MBDEBUG_1] [get_bd_intf_pins mdm_1/MBDEBUG_1]
  ...
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins Debug_SYS_Rst] [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
...
proc create_hier_cell_sequencer_hie { parentCell nameHier } {
  ...
  # Create instance: gpio_seq, and set properties
  set gpio_seq [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_seq ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
 ] $gpio_seq

  # Create instance: rst_USER_CLK_100M, and set properties
  set rst_USER_CLK_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_USER_CLK_100M ]
  ...
  # Create instance: ublaze_seq, and set properties
  set ublaze_seq [ create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:10.0 ublaze_seq ]
  set_property -dict [ list \
   CONFIG.C_DEBUG_ENABLED {1} \
   CONFIG.C_D_AXI {1} \
   CONFIG.C_D_LMB {1} \
  ...
  # Create instance: ublaze_seq_axi_periph, and set properties
  set ublaze_seq_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ublaze_seq_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $ublaze_seq_axi_periph

  # Create instance: ublaze_seq_mem
  create_hier_cell_ublaze_seq_mem $hier_obj ublaze_seq_mem

  # Create interface connections
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins DEBUG] [get_bd_intf_pins ublaze_seq/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins ublaze_seq/DLMB] [get_bd_intf_pins ublaze_seq_mem/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins ublaze_seq/ILMB] [get_bd_intf_pins ublaze_seq_mem/ILMB]
  connect_bd_intf_net -intf_net ublaze_seq_M_AXI_DP [get_bd_intf_pins ublaze_seq/M_AXI_DP] [get_bd_intf_pins ublaze_seq_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ublaze_seq_axi_periph_M00_AXI [get_bd_intf_pins gpio_seq/S_AXI] [get_bd_intf_pins ublaze_seq_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net CPU_RESET_1 [get_bd_pins CPU_RESET] [get_bd_pins rst_USER_CLK_100M/ext_reset_in]
  connect_bd_net -net Net [get_bd_pins out25] [get_bd_pins sequencer_bits/out25]
  connect_bd_net -net axi_gpio_0_gpio_io_o1 [get_bd_pins gpio_seq/gpio_io_o] [get_bd_pins sequencer_bits/vec_in]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mb_debug_sys_rst] [get_bd_pins rst_USER_CLK_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk_1 [get_bd_pins USER_CLK] [get_bd_pins gpio_seq/s_axi_aclk] [get_bd_pins rst_USER_CLK_100M/slowest_sync_clk] [get_bd_pins ublaze_seq/Clk] [get_bd_pins ublaze_seq_axi_periph/ACLK] [get_bd_pins ublaze_seq_axi_periph/M00_ACLK] [get_bd_pins ublaze_seq_axi_periph/S00_ACLK] [get_bd_pins ublaze_seq_mem/USER_CLK]
  connect_bd_net -net rst_USER_CLK_100M_bus_struct_reset [get_bd_pins rst_USER_CLK_100M/bus_struct_reset] [get_bd_pins ublaze_seq_mem/SYS_Rst]
  connect_bd_net -net rst_USER_CLK_100M_interconnect_aresetn [get_bd_pins rst_USER_CLK_100M/interconnect_aresetn] [get_bd_pins ublaze_seq_axi_periph/ARESETN]
  connect_bd_net -net rst_USER_CLK_100M_mb_reset [get_bd_pins rst_USER_CLK_100M/mb_reset] [get_bd_pins ublaze_seq/Reset]
  connect_bd_net -net rst_USER_CLK_100M_peripheral_aresetn [get_bd_pins gpio_seq/s_axi_aresetn] [get_bd_pins rst_USER_CLK_100M/peripheral_aresetn] [get_bd_pins ublaze_seq_axi_periph/M00_ARESETN] [get_bd_pins ublaze_seq_axi_periph/S00_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  set ANA_17 [ create_bd_port -dir O ANA_17 ]
  set ANA_18 [ create_bd_port -dir O ANA_18 ]
  set ANA_19 [ create_bd_port -dir O ANA_19 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins sequencer_hie/DEBUG] [get_bd_intf_pins ublaze_hie/MBDEBUG_1]
  ...
  connect_bd_net -net CPU_RESET_1 [get_bd_ports CPU_RESET] [get_bd_pins adc_a/reset] [get_bd_pins adc_b/reset] [get_bd_pins adc_c/reset] [get_bd_pins adc_d/reset] [get_bd_pins eth_hie/CPU_RESET] [get_bd_pins sequencer_hie/CPU_RESET] [get_bd_pins sys_clk_hie/CPU_RESET] [get_bd_pins ublaze_hie/CPU_RESET]
  ...
  connect_bd_net -net adc_a_dout [get_bd_pins adc_a/dout] [get_bd_pins cds_core_a/din] [get_bd_pins packer/rdata_a]
  connect_bd_net -net adc_a_dout_strobe [get_bd_pins adc_a/dout_strobe] [get_bd_pins cds_core_a/din_ready] [get_bd_pins packer/rready_a]
  connect_bd_net -net adc_b_dout [get_bd_pins adc_b/dout] [get_bd_pins cds_core_b/din] [get_bd_pins packer/rdata_b]
  connect_bd_net -net adc_b_dout_strobe [get_bd_pins adc_b/dout_strobe] [get_bd_pins cds_core_b/din_ready] [get_bd_pins packer/rready_b]
  ...
  connect_bd_net -net adc_c_dout [get_bd_pins adc_c/dout] [get_bd_pins cds_core_c/din] [get_bd_pins packer/rdata_c]
  connect_bd_net -net adc_c_dout_strobe [get_bd_pins adc_c/dout_strobe] [get_bd_pins cds_core_c/din_ready] [get_bd_pins packer/rready_c]
  connect_bd_net -net adc_d_dout [get_bd_pins adc_d/dout] [get_bd_pins cds_core_d/din] [get_bd_pins packer/rdata_d]
  connect_bd_net -net adc_d_dout_strobe [get_bd_pins adc_d/dout_strobe] [get_bd_pins cds_core_d/din_ready] [get_bd_pins packer/rready_d]
  ...
  connect_bd_net -net sequencer_hie_TGL_DGA1 [get_bd_ports ANA_16] [get_bd_ports TGL_DGA] [get_bd_pins sequencer_hie/TGL_DGA]
  connect_bd_net -net sequencer_hie_TGL_DGB1 [get_bd_ports ANA_17] [get_bd_ports TGL_DGB] [get_bd_pins sequencer_hie/TGL_DGB]
  connect_bd_net -net sequencer_hie_TGL_H1A1 [get_bd_ports ANA_5] [get_bd_ports TGL_H1A] [get_bd_pins sequencer_hie/TGL_H1A]
  connect_bd_net -net sequencer_hie_TGL_H1B1 [get_bd_ports ANA_6] [get_bd_ports TGL_H1B] [get_bd_pins sequencer_hie/TGL_H1B]
  connect_bd_net -net sequencer_hie_TGL_H2C1 [get_bd_ports ANA_7] [get_bd_ports TGL_H2C] [get_bd_pins sequencer_hie/TGL_H2C]
  connect_bd_net -net sequencer_hie_TGL_H3A1 [get_bd_ports ANA_8] [get_bd_ports TGL_H3A] [get_bd_pins sequencer_hie/TGL_H3A]
  connect_bd_net -net sequencer_hie_TGL_H3B1 [get_bd_ports ANA_9] [get_bd_ports TGL_H3B] [get_bd_pins sequencer_hie/TGL_H3B]
  connect_bd_net -net sequencer_hie_TGL_OGA1 [get_bd_ports ANA_14] [get_bd_ports TGL_OGA] [get_bd_pins sequencer_hie/TGL_OGA]
  connect_bd_net -net sequencer_hie_TGL_OGB1 [get_bd_ports ANA_15] [get_bd_ports TGL_OGB] [get_bd_pins sequencer_hie/TGL_OGB]
  connect_bd_net -net sequencer_hie_TGL_RGA1 [get_bd_ports ANA_12] [get_bd_ports TGL_RGA] [get_bd_pins sequencer_hie/TGL_RGA]
  connect_bd_net -net sequencer_hie_TGL_RGB1 [get_bd_ports ANA_13] [get_bd_ports TGL_RGB] [get_bd_pins sequencer_hie/TGL_RGB]
  connect_bd_net -net sequencer_hie_TGL_SWA1 [get_bd_ports ANA_10] [get_bd_ports TGL_SWA] [get_bd_pins sequencer_hie/TGL_SWA]
  connect_bd_net -net sequencer_hie_TGL_SWB1 [get_bd_ports ANA_11] [get_bd_ports TGL_SWB] [get_bd_pins sequencer_hie/TGL_SWB]
  connect_bd_net -net sequencer_hie_TGL_TGA1 [get_bd_ports ANA_18] [get_bd_ports TGL_TGA] [get_bd_pins sequencer_hie/TGL_TGA]
  connect_bd_net -net sequencer_hie_TGL_TGB1 [get_bd_ports ANA_19] [get_bd_ports TGL_TGB] [get_bd_pins sequencer_hie/TGL_TGB]
  connect_bd_net -net sequencer_hie_TGL_V1A1 [get_bd_ports ANA_0] [get_bd_ports TGL_V1A] [get_bd_pins sequencer_hie/TGL_V1A]
  connect_bd_net -net sequencer_hie_TGL_V1B1 [get_bd_ports ANA_1] [get_bd_ports TGL_V1B] [get_bd_pins sequencer_hie/TGL_V1B]
  connect_bd_net -net sequencer_hie_TGL_V2C1 [get_bd_ports ANA_2] [get_bd_ports TGL_V2C] [get_bd_pins sequencer_hie/TGL_V2C]
  connect_bd_net -net sequencer_hie_TGL_V3A1 [get_bd_ports ANA_3] [get_bd_ports TGL_V3A] [get_bd_pins sequencer_hie/TGL_V3A]
  connect_bd_net -net sequencer_hie_TGL_V3B1 [get_bd_ports ANA_4] [get_bd_ports TGL_V3B] [get_bd_pins sequencer_hie/TGL_V3B]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces sequencer_hie/ublaze_seq/Data] [get_bd_addr_segs sequencer_hie/gpio_seq/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces sequencer_hie/ublaze_seq/Data] [get_bd_addr_segs sequencer_hie/ublaze_seq_mem/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces sequencer_hie/ublaze_seq/Instruction] [get_bd_addr_segs sequencer_hie/ublaze_seq_mem/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
...
preplace port TGL_H1B -pg 1 -y 5610 -defaultsOSRD
...
preplace port TGL_DGA -pg 1 -y 5810 -defaultsOSRD
preplace port DIGPOT_DIN -pg 1 -y 320 -defaultsOSRD
preplace port TGL_DGB -pg 1 -y 5830 -defaultsOSRD
preplace port TGL_TGA -pg 1 -y 5850 -defaultsOSRD
preplace port DIGPOT_SCLK -pg 1 -y 360 -defaultsOSRD
preplace port DAC_SDI -pg 1 -y 260 -defaultsOSRD
preplace port ANA_10 -pg 1 -y 6200 -defaultsOSRD
preplace port ADC_B_TEST_PTRN -pg 1 -y -2770 -defaultsOSRD -left
preplace port TGL_TGB -pg 1 -y 5870 -defaultsOSRD
preplace port ANA_11 -pg 1 -y 6220 -defaultsOSRD
preplace port TGL_OGA -pg 1 -y 5770 -defaultsOSRD
preplace port ANA_12 -pg 1 -y 6240 -defaultsOSRD
preplace port TGL_OGB -pg 1 -y 5790 -defaultsOSRD
preplace port DAC_CLRn -pg 1 -y 4250 -defaultsOSRD
preplace port ANA_13 -pg 1 -y 6260 -defaultsOSRD
...
preplace port ANA_14 -pg 1 -y 6280 -defaultsOSRD
preplace port ENET_RX0 -pg 1 -y 1920 -defaultsOSRD -right
preplace port ANA_15 -pg 1 -y 6300 -defaultsOSRD
preplace port TGL_RGA -pg 1 -y 5730 -defaultsOSRD
...
preplace port ANA_16 -pg 1 -y 6320 -defaultsOSRD
preplace port TGL_RGB -pg 1 -y 5750 -defaultsOSRD
preplace port ENET_RX2 -pg 1 -y 1960 -defaultsOSRD -right
preplace port ANA_17 -pg 1 -y 6340 -defaultsOSRD
preplace port TGL_H2C -pg 1 -y 5630 -defaultsOSRD
preplace port TGL_V2C -pg 1 -y 5530 -defaultsOSRD
preplace port VOLT_SW_CLK -pg 1 -y 5210 -defaultsOSRD
preplace port ENET_RX3 -pg 1 -y 1980 -defaultsOSRD -right
preplace port ANA_18 -pg 1 -y 6360 -defaultsOSRD
preplace port TGL_SWA -pg 1 -y 5690 -defaultsOSRD
preplace port ENET_RX4 -pg 1 -y 2000 -defaultsOSRD -right
preplace port ANA_19 -pg 1 -y 6380 -defaultsOSRD
preplace port TGL_SWB -pg 1 -y 5710 -defaultsOSRD
...
preplace port ANA_0 -pg 1 -y 6000 -defaultsOSRD
preplace port ANA_1 -pg 1 -y 6020 -defaultsOSRD
preplace port ADC_B_PWRDOWNn -pg 1 -y -2750 -defaultsOSRD -left
preplace port ENET_TXEN -pg 1 -y 2180 -defaultsOSRD
preplace port ANA_2 -pg 1 -y 6040 -defaultsOSRD
preplace port VOLT_SW_CLR -pg 1 -y 3990 -defaultsOSRD
preplace port ANA_3 -pg 1 -y 6060 -defaultsOSRD
preplace port ANA_4 -pg 1 -y 6080 -defaultsOSRD
preplace port VOLT_SW_DIN -pg 1 -y 5160 -defaultsOSRD
preplace port ANA_5 -pg 1 -y 6100 -defaultsOSRD
...
preplace port ANA_6 -pg 1 -y 6120 -defaultsOSRD
preplace port LED1 -pg 1 -y 3230 -defaultsOSRD
preplace port ANA_7 -pg 1 -y 6140 -defaultsOSRD
preplace port LED2 -pg 1 -y 3250 -defaultsOSRD
preplace port ANA_8 -pg 1 -y 6160 -defaultsOSRD
...
preplace port ANA_9 -pg 1 -y 6180 -defaultsOSRD
...
preplace port TGL_V3A -pg 1 -y 5550 -defaultsOSRD
preplace port TGL_H3A -pg 1 -y 5650 -defaultsOSRD
preplace port CCD_VDRAIN_DIGPOT_SDO -pg 1 -y 4640 -defaultsOSRD -right
preplace port LED5 -pg 1 -y 3360 -defaultsOSRD
preplace port TGL_V3B -pg 1 -y 5570 -defaultsOSRD
preplace port TGL_H3B -pg 1 -y 5670 -defaultsOSRD
...
preplace port TGL_V1A -pg 1 -y 5490 -defaultsOSRD
...
preplace port TGL_V1B -pg 1 -y 5510 -defaultsOSRD
...
preplace port TGL_H1A -pg 1 -y 5590 -defaultsOSRD
...
preplace inst xlconstant_0 -pg 1 -lvl 9 -y -630 -defaultsOSRD
...
preplace inst xlconstant_1 -pg 1 -lvl 5 -y 3014 -defaultsOSRD
...
preplace inst gpio_ldo -pg 1 -lvl 6 -y 3120 -defaultsOSRD
preplace inst packer -pg 1 -lvl 5 -y -1350 -defaultsOSRD
preplace inst sequencer_hie -pg 1 -lvl 8 -y 5740 -defaultsOSRD
preplace inst spi_volt_sw -pg 1 -lvl 6 -y 5354 -defaultsOSRD
preplace inst spi_dac -pg 1 -lvl 3 -y 1090 -defaultsOSRD
preplace netloc microblaze_0_axi_periph_M16_AXI 1 3 2 2030 -2010 2520
preplace netloc microblaze_0_axi_periph_M02_AXI 1 4 2 NJ 2340 3210
preplace netloc serial_io_1_adc_cnvrt_p 1 2 8 N -2390 N -2390 N -2390 N -2390 N -2390 N -2390 N -2390 7420
preplace netloc spi_volt_sw_sck_o 1 6 4 4650J 5210 NJ 5210 NJ 5210 NJ
preplace netloc gpio_leds_bits_out4 1 7 3 5470J 3330 NJ 3330 NJ
preplace netloc gpio_telemetry_bits_out0 1 7 3 5470J 3620 NJ 3620 NJ
preplace netloc cds_core_b_dout_ready 1 4 1 2630
preplace netloc sequencer_hie_TGL_RGB1 1 8 2 NJ 5750 7480J
preplace netloc spi_ldo_mux_sdo_out 1 6 2 N 4794 5430
preplace netloc gpio_telemetry_bits_out1 1 7 3 5460J 3580 NJ 3580 NJ
preplace netloc ENET_RX3_1 1 5 5 3420 1980 N 1980 N 1980 N 1980 N
preplace netloc gpio_leds_bits_out5 1 7 3 5450J 3360 NJ 3360 NJ
preplace netloc adc_a_adc_clk_n 1 0 3 N -3370 N -3370 520
preplace netloc gpio_telemetry_bits_out2 1 7 3 NJ 3700 NJ 3700 7600J
preplace netloc microblaze_0_axi_periph_M03_AXI 1 4 2 NJ 2360 3310
preplace netloc adc_bits_out10 1 1 2 140 -2250 560
preplace netloc sequencer_hie_TGL_H3A1 1 8 2 NJ 5650 7530J
preplace netloc packer_0_dout 1 5 1 3350J
preplace netloc gpio_telemetry_bits_out3 1 7 3 5440J 3560 NJ 3560 NJ
preplace netloc eth_resync_0_ENET_TX0 1 6 4 4480 2220 N 2220 N 2220 N
preplace netloc microblaze_0_axi_periph_M01_AXI 1 2 3 680 1950 N 1950 2460J
preplace netloc adc_bits_out11 1 0 3 NJ -2270 N -2270 660
preplace netloc adc_a_adc_clk_p 1 0 3 N -3390 N -3390 530
preplace netloc gpio_telemetry_bits_out4 1 7 3 5520J 3670 NJ 3670 NJ
preplace netloc eth_resync_0_ENET_TX1 1 6 4 4490 2240 N 2240 N 2240 N
preplace netloc xlconstant_3_dout 1 0 10 NJ -3710 90 -3710 N -3710 N -3710 N -3710 N -3710 N -3710 N -3710 N -3710 7610
preplace netloc adc_bits_out12 1 1 2 140 -1980 580
preplace netloc serial_io_2_adc_clk_n 1 2 8 680 -2170 N -2170 N -2170 N -2170 N -2170 N -2170 N -2170 N
preplace netloc gpio_telemetry_bits_out5 1 7 3 5500J 3600 NJ 3600 NJ
preplace netloc eth_resync_0_ENET_TX2 1 6 4 4500 2274 N 2274 N 2274 7420
preplace netloc CCD_VSUB_DIGPOT_SDO_1 1 6 4 4660 4680 N 4680 N 4680 N
preplace netloc adc_bits_out13 1 0 3 N -1750 100 -1740 570
preplace netloc sequencer_hie_TGL_DGB1 1 8 2 NJ 5830 7440J
preplace netloc sequencer_hie_TGL_V1A1 1 8 2 NJ 5490 7610J
preplace netloc eth_resync_0_ENET_TX3 1 6 4 4520 2294 N 2294 N 2294 7430
preplace netloc axi_uartlite_0_tx 1 2 8 580 1220 1910J 1190 NJ 1190 NJ 1190 NJ 1190 NJ 1190 NJ 1190 NJ
preplace netloc microblaze_0_axi_periph_M00_AXI 1 1 4 140J 1210 NJ 1210 NJ 1210 2470
preplace netloc adc_bits_out14 1 1 2 140 -1720 550
preplace netloc serial_io_2_adc_clk_p 1 2 8 690 -2150 N -2150 N -2150 N -2150 N -2150 N -2150 N -2150 N
preplace netloc sequencer_hie_TGL_RGA1 1 8 2 NJ 5730 7490J
preplace netloc eth_resync_0_ENET_TX4 1 6 4 4550 2304 N 2304 N 2304 7610
preplace netloc adc_d_dout_strobe 1 2 3 NJ -1810 1910J -930 2590
preplace netloc adc_bits_out15 1 0 3 NJ -1730 N -1730 620
preplace netloc serial_io_2_adc_cnvrt_n 1 2 8 700 -2130 N -2130 N -2130 N -2130 N -2130 N -2130 N -2130 N
preplace netloc ADC_D_DATA_N_1 1 0 2 N -1880 N
preplace netloc xlconstant_0_dout1 1 5 1 3300
preplace netloc ENET_RX1_1 1 5 5 3400 1940 N 1940 N 1940 N 1940 N
preplace netloc eth_resync_0_ENET_TX5 1 6 4 4570 2320 N 2320 N 2320 N
preplace netloc microblaze_0_axi_periph_M17_AXI 1 3 2 2040 -2000 2510
preplace netloc microblaze_0_M_AXI_DP 1 3 1 1920
preplace netloc serial_io_1_adc_clk_n 1 2 8 N -2450 N -2450 N -2450 N -2450 N -2450 N -2450 N -2450 7610
preplace netloc adc_a_adc_cnvrt_n 1 0 3 N -3410 N -3410 700
preplace netloc eth_resync_0_ENET_TX6 1 6 4 4580 2340 N 2340 N 2340 N
preplace netloc serial_io_2_adc_cnvrt_p 1 2 8 710 -2110 N -2110 N -2110 N -2110 N -2110 N -2110 N -2110 N
preplace netloc serial_io_0_adc_clk_n 1 2 8 N -2930 N -2930 N -2930 N -2930 N -2930 N -2930 N -2930 N
preplace netloc eth_resync_0_ENET_TX7 1 6 4 4610 2360 N 2360 N 2360 N
preplace netloc cds_core_d_dout 1 4 1 2570
preplace netloc serial_io_1_adc_clk_p 1 2 8 N -2430 N -2430 N -2430 N -2430 N -2430 N -2430 N -2430 7600
preplace netloc ADC_B_DATA_P_1 1 0 2 N -2880 N
preplace netloc adc_a_adc_cnvrt_p 1 0 3 N -3430 N -3430 710
preplace netloc sequencer_hie_TGL_V3B1 1 8 2 NJ 5570 7570J
preplace netloc leds_gpio_gpio_io_o 1 6 1 4670
preplace netloc serial_io_0_adc_clk_p 1 2 8 N -2910 N -2910 N -2910 N -2910 N -2910 N -2910 N -2910 N
preplace netloc sequencer_hie_TGL_V3A1 1 8 2 NJ 5550 7580J
preplace netloc microblaze_0_axi_periph_M14_AXI 1 4 1 2600
preplace netloc sequencer_hie_TGL_SWB1 1 8 2 NJ 5710 7500J
preplace netloc ENET_RX4_1 1 5 5 3430 2000 N 2000 N 2000 N 2000 N
preplace netloc gpio_bits_out0 1 7 3 NJ 2920 NJ 2920 NJ
preplace netloc adc_d_dout 1 2 3 NJ -1830 1920J -1080 2560
preplace netloc adc_a_dout 1 2 3 NJ -3200 2010J -2060 2690
preplace netloc spi_ldo_ss_o 1 6 1 4630
preplace netloc spi_ldo_sck_o 1 6 4 4560J 360 NJ 360 NJ 360 NJ
preplace netloc gpio_bits_out1 1 7 3 NJ 2940 NJ 2940 NJ
preplace netloc microblaze_0_axi_periph_M12_AXI 1 4 2 2690 2350 3260
preplace netloc microblaze_0_axi_periph_M08_AXI 1 4 2 2560 2610 3240
preplace netloc spi_volt_sw_io0_o 1 6 4 4510J 5160 NJ 5160 NJ 5160 NJ
preplace netloc packer_header_vec2bit_0_dout 1 4 1 2650
preplace netloc gpio_bits_out2 1 7 3 NJ 2960 NJ 2960 NJ
preplace netloc ENET_RX6_1 1 5 5 3450 2040 N 2040 N 2040 N 2040 N
preplace netloc ENET_RXCLK_1 1 5 5 3370 1880 N 1880 N 1880 N 1880 N
preplace netloc adc_bits_out0 1 1 2 90 -3350 610
preplace netloc CPU_RESET_1 1 0 8 NJ 100 90 1970 580 1970 NJ 1970 NJ 1970 3330 2284 N 2284 5490
preplace netloc gpio_bits_out3 1 7 3 NJ 2980 NJ 2980 NJ
preplace netloc mdm_1_debug_sys_rst 1 3 5 1930 1960 N 1960 3340 1970 N 1970 5510
preplace netloc adc_bits_out1 1 0 3 N -3130 100 -3090 540
preplace netloc sequencer_hie_TGL_H2C1 1 8 2 NJ 5630 7540J
preplace netloc gpio_ldo_gpio_io_o 1 6 1 4670J
preplace netloc gpio_bits_out4 1 7 3 NJ 3000 NJ 3000 NJ
preplace netloc adc_b_dout 1 2 3 NJ -2850 1990J -2040 2670
preplace netloc adc_bits_out2 1 1 2 140 -3100 600
preplace netloc microblaze_0_axi_periph_M18_AXI 1 3 2 2040 -880 2500
preplace netloc adc_c_dout 1 2 3 NJ -2370 1930J -940 2550
preplace netloc adc_bits_out3 1 0 3 NJ -3110 N -3110 670
preplace netloc sequencer_hie_TGL_H1A1 1 8 2 NJ 5590 7560J
preplace netloc microblaze_0_Clk_1 1 0 8 NJ 380 80 3074 N 3074 N 3074 N 3074 3420 3040 4610 3060 5480
preplace netloc adc_bits_out4 1 1 2 140 -3000 590
preplace netloc gpio_volt_sw_gpio_io_o 1 6 1 4670
preplace netloc adc_c_dout_strobe 1 2 3 NJ -2350 1940J -2030 2660
preplace netloc adc_bits_out5 1 0 3 N -2770 100 -2740 530
preplace netloc microblaze_0_Clk 1 1 5 120 980 550 980 1960 -900 2690 -900 3280
preplace netloc adc_bits_out6 1 1 2 140 -2760 650
preplace netloc sequencer_hie_TGL_OGA1 1 8 2 NJ 5770 7470J
preplace netloc cds_core_c_dout 1 4 1 2570
preplace netloc xlconstant_2_dout 1 4 1 2680
preplace netloc adc_b_dout_strobe 1 2 3 NJ -2830 1980J -2050 2680
preplace netloc adc_bits_out7 1 0 3 NJ -2750 N -2750 640
preplace netloc gpio_telemetry_gpio_io_o 1 6 1 4670
preplace netloc TEL_DOUT_1 1 0 7 NJ 340 100 260 N 260 1920 270 N 270 N 270 4460
preplace netloc ENET_RX5_1 1 5 5 3440 2020 N 2020 N 2020 N 2020 N
preplace netloc cds_core_d_dout_ready 1 4 1 2540
preplace netloc adc_bits_out8 1 1 2 130 -2260 520
preplace netloc ADC_C_DATA_P_1 1 0 2 N -2400 N
preplace netloc spi_dac_ss_o 1 3 7 1950 260 NJ 260 NJ 260 NJ 260 NJ 260 NJ 260 7420J
preplace netloc adc_bits_out9 1 0 3 N -2290 100 -2280 630
preplace netloc spi_telemetry_sck_o 1 6 4 4620J 880 NJ 880 NJ 880 NJ
preplace netloc cds_core_a_dout 1 4 1 2640
preplace netloc cds_core_c_dout_ready 1 4 1 2610
preplace netloc sequencer_hie_TGL_TGB1 1 8 2 NJ 5870 7420J
preplace netloc spi_ldo_io0_o 1 6 4 4530J 320 NJ 320 NJ 320 NJ
preplace netloc spi_dac_sck_o 1 3 7 1930 240 NJ 240 NJ 240 NJ 240 NJ 240 NJ 240 NJ
preplace netloc packer_0_dready 1 5 1 3360J
preplace netloc eth_resync_0_ENET_GTXCLK 1 6 4 4470 2160 N 2160 N 2160 N
preplace netloc Net 1 3 6 2020 -910 N -910 N -910 N -910 N -910 7010
preplace netloc CCD_VDD_DIGPOT_SDO_1 1 6 4 4670 4640 5560 4620 N 4620 N
preplace netloc eth_resync_0_ENET_TXEN 1 6 4 4510 2180 N 2180 N 2180 N
preplace netloc microblaze_0_axi_periph_M11_AXI 1 4 2 NJ 2520 3320
preplace netloc microblaze_0_axi_periph_M10_AXI 1 4 2 2540 2650 3220
preplace netloc serial_io_0_adc_cnvrt_n 1 2 8 N -2890 N -2890 N -2890 N -2890 N -2890 N -2890 N -2890 N
preplace netloc clk_wiz_1_locked 1 2 1 700
preplace netloc ENET_RX0_1 1 5 5 3390 1920 N 1920 N 1920 N 1920 N
preplace netloc microblaze_0_debug 1 3 5 1910 1980 2540 1990 N 1990 N 1990 5530
preplace netloc microblaze_0_axi_periph_M09_AXI 1 4 2 2550 2630 3230
preplace netloc sequencer_bits_out26 1 3 6 2050 -920 N -920 N -920 N -920 N -920 7020
preplace netloc CCD_VDRAIN_DIGPOT_SDO_1 1 6 4 4640 4650 N 4650 N 4650 7430
preplace netloc adc_a_dout_strobe 1 2 3 NJ -3180 2000J -2070 2700
preplace netloc serial_io_0_adc_cnvrt_p 1 2 8 N -2870 N -2870 N -2870 N -2870 N -2870 N -2870 N -2870 N
preplace netloc sequencer_hie_TGL_V2C1 1 8 2 NJ 5530 7590J
preplace netloc spi_ldo_mux_ss0_out 1 7 3 5560J 4490 NJ 4490 NJ
preplace netloc gpio_dac_gpio_io_o 1 6 1 4670
preplace netloc ENET_RX7_1 1 5 5 3460 2060 N 2060 N 2060 N 2060 N
preplace netloc eth_resync_0_ENET_TXER 1 6 4 4540 2200 N 2200 N 2200 N
preplace netloc sequencer_hie_TGL_H3B1 1 8 2 NJ 5670 7520J
preplace netloc sequencer_hie_TGL_DGA1 1 8 2 NJ 5810 7450J
preplace netloc vec2bit_2_0_out0 1 7 3 5550 3990 N 3990 N
preplace netloc spi_telemetry_io0_o 1 6 4 4590J 740 NJ 740 NJ 740 NJ
preplace netloc rst_clk_wiz_1_100M_interconnect_aresetn 1 3 1 1940
preplace netloc ENET_RXDV_1 1 5 5 3380 1900 N 1900 N 1900 N 1900 N
preplace netloc microblaze_0_axi_periph_M06_AXI 1 4 2 2570 2570 3270
preplace netloc ADC_A_DATA_P_1 1 0 2 N -3230 N
preplace netloc vec2bit_2_0_out1 1 7 3 N 4030 N 4030 N
preplace netloc clk_wiz_1_clk_out2 1 2 4 620 3064 1980 3084 N 3084 3200
preplace netloc DAC_SDO_1 1 0 4 NJ 120 NJ 120 NJ 120 1910
preplace netloc sequencer_hie_TGL_V1B1 1 8 2 NJ 5510 7600J
preplace netloc spi_ldo_mux_ss2_out 1 7 3 5560J 4520 NJ 4520 NJ
preplace netloc spi_dac_io0_o 1 3 7 1940 250 NJ 250 NJ 250 NJ 250 NJ 250 NJ 250 7600J
preplace netloc VOLT_SW_DOUT_1 1 6 4 4600 5190 N 5190 N 5190 N
preplace netloc microblaze_0_axi_periph_M04_AXI 1 4 2 2590 2530 3290
...
preplace netloc sequencer_hie_TGL_H1B1 1 8 2 NJ 5610 7550J
preplace netloc CCD_VR_DIGPOT_SDO_1 1 6 4 4650 4660 N 4660 N 4660 N
preplace netloc microblaze_0_axi_periph_M07_AXI 1 2 3 680J 1200 NJ 1200 2480
preplace netloc xlconstant_0_dout 1 9 1 7600
preplace netloc spi_telemetry_ss_o 1 6 4 4600J 720 NJ 720 NJ 720 NJ
preplace netloc spi_ldo_mux_ss3_out 1 7 3 5560J 4550 NJ 4550 NJ
preplace netloc microblaze_0_axi_periph_M19_AXI 1 1 4 140J 280 NJ 280 NJ 280 2490
preplace netloc axi_gpio_0_gpio_io_o 1 1 2 140 -1100 520
preplace netloc sequencer_hie_TGL_SWA1 1 8 2 NJ 5690 7510J
preplace netloc sequencer_hie_TGL_OGB1 1 8 2 NJ 5790 7460J
preplace netloc ENET_RX2_1 1 5 5 3410 1960 N 1960 N 1960 N 1960 N
preplace netloc gpio_dac_bits_out0 1 7 3 5550 4270 N 4270 N
preplace netloc gpio_leds_bits_out0 1 7 3 5430J 3210 NJ 3210 NJ
preplace netloc cds_core_b_dout 1 4 1 2620
preplace netloc gpio_dac_bits_out1 1 7 3 5540 4250 N 4250 N
preplace netloc gpio_leds_bits_out1 1 7 3 5440J 3230 NJ 3230 NJ
preplace netloc USB_UART_TX_1 1 0 3 NJ 360 110 270 520
preplace netloc microblaze_0_axi_periph_M15_AXI 1 3 2 2020 -2020 2530
preplace netloc microblaze_0_axi_periph_M05_AXI 1 4 2 2580 2550 3260
preplace netloc serial_io_1_adc_cnvrt_n 1 2 8 N -2410 N -2410 N -2410 N -2410 N -2410 N -2410 N -2410 7430
preplace netloc ADC_C_DATA_N_1 1 0 2 N -2420 N
preplace netloc sequencer_hie_TGL_TGA1 1 8 2 NJ 5850 7430J
preplace netloc spi_ldo_mux_ss1_out 1 7 3 5550J 4470 NJ 4470 NJ
preplace netloc gpio_dac_bits_out2 1 7 3 5560 4290 N 4290 N
preplace netloc gpio_leds_bits_out2 1 7 3 5450J 3250 NJ 3250 NJ
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 1 5 130 1220 530 1230 1970 -890 2700 -890 3250
preplace netloc gpio_dac_bits_out3 1 7 3 N 4350 N 4350 N
preplace netloc gpio_leds_bits_out3 1 7 3 5460J 3270 NJ 3270 NJ
preplace netloc cds_core_a_dout_ready 1 4 1 2650
levelinfo -pg 1 -350 0 380 1760 2306 3050 4320 5320 6880 7340 7630 -top -4220 -bot 6790
",
}
